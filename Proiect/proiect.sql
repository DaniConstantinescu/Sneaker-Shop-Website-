...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1747064703ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect&table=users">`proiect`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect&table=produse">`proiect`.`produse`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect&table=facturi">`proiect`.`facturi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect&table=cos_cumparaturi">`proiect`.`cos_cumparaturi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect&table=cos+cumparaturi">`proiect`.`cos cumparaturi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect&table=mytable">`proiect`.`mytable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=lab10&table=ex2">`lab10`.`ex2`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=proiect&table=Users">`proiect`.`Users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test1&table=elevi">`test1`.`elevi`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="47704629625a53296c33233254786447">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="proiect" targettable="facturi">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `facturi`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="facturi">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `facturi`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`  
ORDER BY `users`.`id`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="facturi">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `facturi` (`id_factura`, `id_client`, `comanda`, `dataa`, `ora`) VALUES (NULL, &#039;201&#039;, &#039;{\&quot;produse\&quot;:[5]}&#039;, &#039;12.04.2022&#039;, &#039;17.03&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="facturi">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `facturi`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="produse">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `produse`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="produse">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `produse`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="andrei" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="cos_cumparaturi">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cos_cumparaturi`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="proiect" targettable="facturi">
                            <div class="action_content">
